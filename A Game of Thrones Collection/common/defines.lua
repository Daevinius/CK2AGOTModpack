...
NAI =
{
	...
	MARRIAGE_THREATENING_FOR_US = 2,						-- How much AI will prefer marriages towards threatening realms
	MARRIAGE_LANDED_AND_NO_NAP = 4,							-- How much AI will prefer marriages with landed characters AI do not have non-aggression pacts with
	MARRIAGE_LANDED = 12,									-- How much AI will prefer marriages with landed characters
	MARRIAGE_PRIMARY_HEIR = 16,								-- How much AI will prefer marriages with primary heirs of landed characters
	MARRIAGE_SECONDARY_HEIR = 12,							-- How much AI will prefer marriages with secondary heirs of landed characters
	MARRIAGE_CHILD_OF_RULER = 8,							-- How much AI will prefer marriages with children of landed characters
	MARRIAGE_ALLIED_AND_NO_NAP = 2,							-- How much AI will prefer marriages with allies they don't have non-aggression pacts with
